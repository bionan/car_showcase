      ...
      <Transition appear show={isOpen} as={Fragment}>
        <Dialog as="div" className="relative z-10" onClose={closeModal}>
          <Transition.Child
            ...
            enterFrom="opacity-0" // opaco
            enterTo="opacity-100" // transparente
          ...
          <div className="fixed inset-0 overflow-y-auto">
            ...
            <Transition.Child
              as={Fragment}
              enter="ease-out duration-300"
              enterFrom="opacity-0 scale-95" // opaco
              enterTo="opacity-100 scale-100" // transparente
              leave="ease-in duration-200"
            ...
            <Dialog.Panel className="relative bg-white w-full max-w-lg max-h-[90vh] overflow-y-auto text-left rounded-2xl shadow-xsl transition-all flex gap-5 p-6 flex-col">
              ...
              <div className="flex-1 flex flex-col gap-3">
                ...
                <div className="flex gap-3">
                  ...
                  <div className="flex-1 relative h-24 w-full bg-white rounded-lg">
                    <Image src="/hero.png" alt="car model" fill priority className="object-contain" />
                  </div>
                  <div className="flex-1 relative h-24 w-full bg-white rounded-lg">
                    <Image src="/hero.png" alt="car model" fill priority className="object-contain" />
              ...
              <div className="flex-1 flex flex-col gap-2">
                ...
                <div className="mt-3 flex flex-wrap gap-4 bg-blue-100">
                  ...
                  {Object.entries(car).map(
                    ([key,value]) => {
                      return (
                        <div class="flex justify-between gap-5 w-full text-right" key={key}>
